<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Apertura.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="proyecto2APSW.Apertura" %>
...
<div class="vertical">
    ...
    <asp:DropDownList ID="ddlArea" CssClass="opciones" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlArea_SelectedIndexChanged">
        <asp:ListItem>Administración</asp:ListItem>
        
    </asp:DropDownList>
    <asp:DropDownList ID="ddlDependencia" CssClass="opciones"  runat="server">
        <asp:ListItem>Dep. de Admin</asp:ListItem>
    </asp:DropDownList>
...
<div class="vertical">
    <asp:DropDownList ID="ddlComponente" CssClass="opciones"  runat="server">
        <asp:ListItem>Compromiso</asp:ListItem>
    </asp:DropDownList>
 

    <asp:DropDownList ID="ddlNivel" CssClass="opciones" runat="server">
        <asp:ListItem>Incipiente</asp:ListItem>
    </asp:DropDownList>
</div>   
<br>
       <asp:Button ID="btnEnviar" CssClass="button2" runat="server" Text="Enviar Petición" OnClick="btnEnviar_Click" />
...
<div class="fondo">
      ...
      <script>
         function cargar(c) {
             ...
             window.location.href = "Apertura.aspx/?nombre=" + nombrec;
