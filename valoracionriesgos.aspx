<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="valoracionriesgos.aspx.cs" Inherits="proyecto2APSW.valoracionriesgos" %>
			...
			<div class="col" ontouchstart="this.classList.toggle('hover');">
				...
				<div class="container">
					<div class="front" style="background-image: url(https://i2.wp.com/www.revistanuve.com/wp-content/uploads/2020/08/Oficina.jpg2_.jpg)">
						<div class="inner">
							<p>Herramienta para la administración de la información</p>
						</div>
					</div>
					<div class="back">
						<div class="inner">
			...
			<div class="col" ontouchstart="this.classList.toggle('hover');">
				<div class="container">
					<div class="front" style="background-image: url(https://www.esan.edu.pe/conexion/actualidad/2019/09/09/1500x844_oficinas_satelites.jpg)">
						<div class="inner">
							<p>Documentación y comunicación</p>
						</div>
					</div>
					<div class="back">
						<div class="inner">
