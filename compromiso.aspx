<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="compromiso.aspx.cs" Inherits="proyecto2APSW.compromiso" %>
...
<body>
  ...
  <div class="banner">
    ...
    <br>
    <br>
    <h1 class="titulo">&nbsp &nbsp Compromiso</h1>
   <p class="A2">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<a class="A2" href="">Inicio</a> &nbsp > &nbsp Ambiente de control &nbsp > &nbsp Compromiso</p>
</div>
    ...
    <script>
        function cargar(c) {
            ...
            if (!miCheckbox.checked) {
                window.location.href = "compromiso.aspx?valor=1;"+c.id;
            } 
        ...
        function descargar(c) {
            var nombrec = c.name;
                ...
                window.location.href = "compromiso.aspx?valor=2;" + nombrec;
