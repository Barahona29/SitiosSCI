<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="personal.aspx.cs" Inherits="proyecto2APSW.personal" %>
...
<body>
  ...
  <div class="banner">
    ...
    <br>
    <br>
    <h1 class="titulo">&nbsp &nbsp Personal</h1>
   <p class="A2">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<a class="A2" href="">Inicio</a> &nbsp > &nbsp Ambiente de control &nbsp > &nbsp Personal</p>
</div>
...
<p style="text-align: center;">
    <asp:Label ID="lblo" runat="server" Visible="false" Text=""></asp:Label></p>
    ...
    <script>
        function cargar(c) {
            ...
            if (!miCheckbox.checked) {
                window.location.href = "personal.aspx?valor=1;"+c.id;
            } 
        ...
        function descargar(c) {
            ...
            window.location.href = "personal.aspx?valor=2;" + nombrec;
