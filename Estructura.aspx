<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Estructura.aspx.cs" Inherits="proyecto2APSW.Estructura" %>
...
<body>
  ...
  <div class="banner">
    ...
    <br>
    <br>
    <h1 class="titulo">&nbsp &nbsp Estructura</h1>
   <p class="A2">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<a class="A2" href="">Inicio</a> &nbsp > &nbsp Ambiente de control &nbsp > &nbsp Estructura</p>
</div>
    ...
    <script>
        function cargar(c) {
            ...
            if (!miCheckbox.checked) {
                window.location.href = "Estructura.aspx?valor=1;"+c.id;
            } 
        ...
        function descargar(c) {
            ...
            window.location.href = "Estructura.aspx?valor=2;" + nombrec;
